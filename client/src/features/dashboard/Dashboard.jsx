...
const cryptos = [
  { symbol: 'BTC', name: 'Bitcoin', price: '67,200.00', change: '+2.15%', forecast24h: '+1.8%', forecast7d: '+4.2%', gain: '$2,350.00 (18%)', icon: '🟠' },
  { symbol: 'ETH', name: 'Ethereum', price: '3,120.50', change: '-0.85%', forecast24h: '+0.5%', forecast7d: '+2.1%', gain: '$1,120.50 (9%)', icon: '🟣' },
  { symbol: 'BNB', name: 'Binance Coin', price: '590.10', change: '+1.02%', forecast24h: '+1.2%', forecast7d: '+3.0%', gain: '$890.00 (12%)', icon: '🟡' },
  { symbol: 'SOL', name: 'Solana', price: '155.30', change: '+4.12%', forecast24h: '+2.7%', forecast7d: '+6.5%', gain: '$2,010.00 (22%)', icon: '🟩' },
  { symbol: 'DOGE', name: 'Dogecoin', price: '0.1620', change: '-1.25%', forecast24h: '-0.3%', forecast7d: '+0.8%', gain: '$120.00 (2%)', icon: '🟤' },
]
          ...
          <tbody>
            {cryptos.map((c) => (
              <tr key={c.symbol}>
                ...
                <td className={c.gain.includes('-') ? 'down' : 'up'}>{c.gain}</td>
                <td>
